    ...
    <div class="card-body">
        <form method="POST" action="{{ url('/product/find') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" id="name" name="price" value="{{ $name ?? old('price') }}" />
            </div>

            <div class="form-group">
                <button class="btn btn-success" type="submit">find</button>
                <button class="btn btn-warning" type="reset">reset</button>
                <a class="btn btn-dark" href="{{ route('prodfind') }}">reload</a>
                <a class="btn btn-info" href="{{ url('/product/list') }}">return list</a>
            </div>
